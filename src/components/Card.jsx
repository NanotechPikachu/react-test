  ...
  return (
    <div className={`border md:w-96 p-5 m-5 bg-zinc-900 backdrop-blur overflow-hidden flex flex-col items-start ${className}`}>
      <div className="flex items-center w-full">
        {icon && (
          <svg className="text-blue-500 w-6 h-6 mr-2 mt-1 align-middle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <span className={`text-2xl font-bold mb-4 text-white whitespace-pre-line ${icon ? 'flex-grow' : ''}`}>{title}</span>
      </div>
