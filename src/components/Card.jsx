...
export default function Card({ title, children, icon, className }) {
  return (
    <div className={`border md:w-96 p-5 m-5 bg-zinc-900 backdrop-blur overflow-hidden flex items-center ${className}`}>
      {icon && (
        <svg className="text-blue-500 w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          {/* Replace with your actual SVG path */}
          <path d="M0 25h40m-30-20l20 20-20 20" fill="none" stroke="blue" stroke-width="5"/>
        </svg>
      )}
